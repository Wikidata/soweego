...
COMPLETE_FEATURE_VECTORS = '%s_%s_%s_complete_feature_vectors.pkl'
COMPLETE_WIKIDATA_CHUNKS = '%s_%s_%s_complete_wikidata_chunks.pkl'
COMPLETE_TARGET_CHUNKS = '%s_%s_%s_complete_target_chunks.pkl'
COMPLETE_POSITIVE_SAMPLES_INDEX = '%s_%s_%s_complete_positive_samples_index.pkl'
