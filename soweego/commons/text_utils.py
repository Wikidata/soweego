...
STOPWORDS_ENG = frozenset(str(get_data(
    'soweego.commons.resources', 'stopwords_eng.txt'), 'utf8').splitlines())
COMMON_WORDS_ENG = frozenset(str(get_data(
    'soweego.commons.resources', 'common_words_eng.txt'), 'utf8').splitlines())
