...
class MnMCatalog(BASE):
    ...
    wd_prop = Column(Integer(11), index=True)
    wd_qual = Column(Integer(11))
...
class MnMEntry(BASE):
    ...
    q = Column(Integer(11), index=True)
