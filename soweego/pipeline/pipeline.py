...
@click.option('--validator-only/--all', default=False, help='Excludes from execution non validator steps. Default: no.')
...
def pipeline(target: str, validator: bool, validator_only: bool, credentials_path: str, output_dir: str):
