...
CLI_COMMANDS = {
    'class_based_identifier_query': sparql_queries.identifier_class_based_query_cli,
    'occupation_based_identifier_query': sparql_queries.identifier_occupation_based_query_cli,
