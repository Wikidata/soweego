...
CLI_COMMANDS = {
    'class_based_identifier_query': sparql_queries.class_based_identifier_query,
    'occupation_based_identifier_query': sparql_queries.occupation_based_identifier_query,
